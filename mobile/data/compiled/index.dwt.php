...
<script type="text/javascript" src="<?php echo $this->_var['ectouch_themes']; ?>/js/jquery.superslide.2.1.1.js"></script>
...
<script>
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      imgUrl: '<?php echo $this->_var['site_url']; ?>mobile/home.jpg',
