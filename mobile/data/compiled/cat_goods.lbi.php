...
?>
    ...
    <div class="flex flex-f-row">
        <?php $_from = $this->_var['cat_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_15976200_1542181852');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_15976200_1542181852']):
        $this->_foreach['goods']['iteration']++;
?>
        <div class="goodsItem flex_in">
            <a href="<?php echo $this->_var['goods_0_15976200_1542181852']['url']; ?>">
                <img src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods_0_15976200_1542181852']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_15976200_1542181852']['name']); ?>" />
            </a>
            <div class="goods_center">
				<?php if ($this->_var['goods_0_15976200_1542181852']['promote_price'] != ""): ?> 
				<span class="price_s"> <?php echo $this->_var['goods_0_15976200_1542181852']['promote_price']; ?> <a href="javascript:;" onclick="categoryaddToCart2(<?php echo $this->_var['goods_0_15976200_1542181852']['id']; ?>)" class="catbuybtn"></a></span> 
				<?php else: ?> 
				<span class="price_s"> <?php echo $this->_var['goods_0_15976200_1542181852']['shop_price']; ?> <a href="javascript:;" onclick="categoryaddToCart2(<?php echo $this->_var['goods_0_15976200_1542181852']['id']; ?>)" class="catbuybtn"></a></span> 
				<?php endif; ?>
				<p class="goods_tit"><?php echo sub_str(htmlspecialchars($this->_var['goods_0_15976200_1542181852']['name']),12); ?></p>
            </div>
        </div>
