  ...
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['ad_name']; ?></td>
      <td>
  ...
  <?php if ($this->_var['ads']['media_type'] == 0 || $this->_var['action'] == "add"): ?>
    ...
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['upfile_img']; ?></td>
      <td>
  ...
  <?php if ($this->_var['ads']['media_type'] == 1 || $this->_var['action'] == "add"): ?>
    ...
    <tr>
      <td  class="label">
        ...
        <img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['upfile_flash']; ?></td>
      <td>
