...
?>
                <li><div class="groupimg"><a href="<?php echo $this->_var['goods']['url']; ?>"><img src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods']['thumb']; ?>" /></a></div>
		<div class="grouptit"><?php echo sub_str(htmlspecialchars($this->_var['goods']['goods_name']),12); ?></div>
		<div class="groupprice"><span class="last_price"><?php echo $this->_var['goods']['last_price']; ?></span><span class="zhekou"><?php echo $this->_var['goods']['zhekou']; ?>折</span></div>
                </li>
