...
?>   
        <?php if ($this->_var['child']['ico']): ?> 
        <div class="fen_img">     
        <a href="<?php echo $this->_var['child']['url']; ?>"><span><img alt="" src="<?php echo $this->_var['child']['ico']; ?>"></span><em><?php echo htmlspecialchars($this->_var['child']['name']); ?></em></a> 
        </div>
        <?php else: ?>
        <div class="fen">
        <a href="<?php echo $this->_var['child']['url']; ?>"><?php echo $this->_var['child']['name']; ?></a> 
        </div>  
		<?php endif; ?>  
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </div>
