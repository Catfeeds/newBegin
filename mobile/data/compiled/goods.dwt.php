...
<section class="goodsInfo_time">
		<script type="text/javascript" src="<?php echo $this->_var['ectouch_themes']; ?>/js/jquery.countdown-2.5.3.min.js"></script>
		  <ul>
		    <li><span class="time_title">限时秒杀</span> <span class="time"><time class="countdown" id="timedown"><font id="ps_labels_<?php echo $this->_var['goods']['goods_id']; ?>" over="false"></font><strong id="ps_cd_<?php echo $this->_var['goods']['goods_id']; ?>" style="color:#abd012;"><?php echo $this->_var['lang']['please_waiting']; ?></strong><font id="ps_labele_<?php echo $this->_var['goods']['goods_id']; ?>" over="false"></font></time></span> </li>
		  </ul>
		<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
