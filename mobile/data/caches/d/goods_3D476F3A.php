...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201707/thumb_img/5_thumb_G_1498959171675.jpg"  alt="小白菜" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:100%;height:auto;" src="/images/201707/goods_img/5_P_1498959171415.jpg" /></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
  ...
  <a class="collect" id="collect_box" href="javascript:collect(5)" style="display: inline;"></a>
</section>
<script type="text/javascript">
TouchSlide({ 
	slideCell:"#slideBox",
...
<section class="goodsInfo_title">
  ...
  <ul>
    <li>
         	<b class="price">￥<span>2.6</span></b>
       
           <p class="xiaoliang">已售出 <span class="sales">50</span> </p>
    </li>
  </ul>
  <div class="blank1"></div>
  <h1> 小白菜 </h1>
...
<section id="choose_good_user" style="height:0; overflow:hidden;">
    <section class="good_user_service">
        ...
        <ul>
	            <li>
                <p class="p_left">QQ用户：￥<span>2.6</span></p>
	    </li>
	            <li>
                <p class="p_left">一星用户：￥<span>2.5</span></p>
	    </li>
	            <li>
                <p class="p_left">二星用户：￥<span>2.3</span></p>
	    </li>
		            <li>
                <p class="p_left">购买此商品可使用：200积分</p>
	    </li>
			        </ul>
    </section>
...
<section id="choose_good_canshu" style="height:0; overflow:hidden;">
    <section class="good_canshu">
        ...
        <ul>
            <li>
                <p class="p_left">商品名称：</p><p class="p_right">小白菜</p>
	    </li>
	                <li>
                <p class="p_left">商品编号：</p><p class="p_right">MDZ000005</p>
	    </li>
	    	    	                <li>
                <p class="p_left">上架时间：</p><p class="p_right">2017-07-02</p>
	    </li>
	    	                <li>
...
<img  id="ECS_GOODS_ATTR_THUMB" src="/images/201707/thumb_img/5_thumb_G_1498959171675.jpg" style=" float:left;">
...
.spxq_main table td div, .spxq_main table td span {
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		...
	  		<p><a href="http://www.0769web.net"><img src="images/upload/Image/201606.jpg" alt="" /></a></p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:5;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1542182077,
    nonceStr: 'Si6JxjDPDjnNOiPY',
    signature: 'a59e3ed6b6436cf64c1fb64942a1494beb16119f',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '小白菜',
      link: '',
      imgUrl: '/images/201707/thumb_img/5_thumb_G_1498959171675.jpg',
...
function choose_attr(num){
	...
	$(".page_mask").show();
        if(num == 0){
            ...
            actionForm.action = "javascript:addToCart(5),close_choose_attr()";
        }
        if(num == 1){
            var actionForm = document.getElementById('ECS_FORMBUY');  
            actionForm.action = "javascript:addToCart_quick(5),close_choose_attr()";
        }
}
