<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:66:"D:/wamp/wamp/www/new/newBegin/mobile/themes/shengxian/category.dwt";i:1;s:76:"D:/wamp/wamp/www/new/newBegin/mobile/themes/shengxian/library/goods_list.lbi";i:2;s:77:"D:/wamp/wamp/www/new/newBegin/mobile/themes/shengxian/library/page_footer.lbi";}s:7:"expires";i:1542341207;s:8:"maketime";i:1542339407;}<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
<title>休闲零食_丽花农产品</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  <header id="header" style="z-index:1">
    ...
    <div class="header_r header_search"> <a class="ico_01" href="flow.php"> 购物车 </a> </div>
  </header>
  <div class="categoryleve clearfix">
									<a  href="category.php?id=23">休闲零食</a>
							<a  href="category.php?id=24">饼干糕点</a>
							<a  href="category.php?id=25">地方特产</a>
							<a  href="category.php?id=26">干果蜜饯</a>
							<a  href="category.php?id=27">糖果巧克力</a>
							<a  href="category.php?id=28">散装休闲食品</a>
							<a  href="category.php?id=29">保健/礼品</a>
					</div>
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list">销量 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb f-ico-triangle-slctd"></i> </span> </a> </li>
      <li class=""> <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      <li class=""> <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=3&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<div class="global-nav">
    <div class="global-nav__nav-wrap">
        ...
        <div class="global-nav__nav-item">
            <a href="cat_all.php" class="global-nav__nav-link global-nav__nav-cur">
...
<script type="text/javascript" src="themes/shengxian/js/jquery.more.cat.js"></script>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=3&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=DESC'})
});
</script>
<script type="text/javascript">
