...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201707/thumb_img/19_thumb_G_1498963709612.jpg"  alt="福建蜜柚" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:100%;height:auto;" src="/images/201707/goods_img/19_P_1498963709267.jpg" /></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo_title">
  ...
  <ul>
    <li>
         	<b class="price">￥<span>10.7</span></b>
       
           <p class="xiaoliang">已售出 <span class="sales">40</span> </p>
    </li>
  </ul>
  <div class="blank1"></div>
  <h1> 福建蜜柚 </h1>
...
<section id="choose_good_user" style="height:0; overflow:hidden;">
    <section class="good_user_service">
        ...
        <ul>
	            <li>
                <p class="p_left">QQ用户：￥<span>10.7</span></p>
	    </li>
	            <li>
                <p class="p_left">一星用户：￥<span>10.2</span></p>
	    </li>
	            <li>
                <p class="p_left">二星用户：￥<span>9.7</span></p>
	    </li>
		            <li>
                <p class="p_left">购买此商品可使用：1000积分</p>
	    </li>
			        </ul>
    </section>
...
<section id="choose_good_canshu" style="height:0; overflow:hidden;">
    <section class="good_canshu">
        ...
        <ul>
            <li>
                <p class="p_left">商品名称：</p><p class="p_right">福建蜜柚</p>
	    </li>
	                <li>
                <p class="p_left">商品编号：</p><p class="p_right">MDZ000019</p>
	    </li>
	    	    	                <li>
                ...
                <p class="p_left">商品重量：</p><p class="p_right">0克</p>
	    	    	      	        		    ...
	    	    	      	        		    <li>
			<p class="p_left">产地：</p><p class="p_right">海南</p>
		    </li>
	        		    <li>
			<p class="p_left">品种：</p><p class="p_right">橙</p>
		    </li>
	        		    <li>
...
<img  id="ECS_GOODS_ATTR_THUMB" src="/images/201707/thumb_img/19_thumb_G_1498963709612.jpg" style=" float:left;">
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1542182138,
    nonceStr: 'ehW0HKOsHyVtL6wh',
    signature: 'f27243723cf1a1905e5b24c213e09df7532929ba',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '福建蜜柚',
      link: '',
      imgUrl: '/images/201707/thumb_img/19_thumb_G_1498963709612.jpg',
...
function choose_attr(num){
	...
	$(".page_mask").show();
        if(num == 0){
            ...
            actionForm.action = "javascript:addToCart(19),close_choose_attr()";
        }
        if(num == 1){
            var actionForm = document.getElementById('ECS_FORMBUY');  
            actionForm.action = "javascript:addToCart_quick(19),close_choose_attr()";
        }
}
