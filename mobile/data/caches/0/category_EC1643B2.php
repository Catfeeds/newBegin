...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <div class="categoryleve clearfix">
									<a  href="category.php?id=7">蔬菜</a>
							<a  href="category.php?id=8">水果</a>
							<a  href="category.php?id=9">鲜肉/禽/蛋</a>
							<a  href="category.php?id=10">豆制品</a>
							<a  href="category.php?id=11">冷冻冷藏</a>
							<a  href="category.php?id=12">熟食系列</a>
							<a  href="category.php?id=13">海鲜／水产</a>
					</div>
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      ...
      <li class=""> <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="8">广西</a></li>
             
                        <li class="filter_attr"> 
               
              <a href="javascript:void(0);" data="14">河北</a></li>
             
                        <li class="filter_attr"> 
               
              <a href="javascript:void(0);" data="11">海南</a></li>
                      </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:void(0);">查看更多<i></i></a> </div>
        </div>
      </div>
            <div class="attr brandAttr">
        <div class="attrKey">品种</div>
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="12">橙</a></li>
             
                        <li class="filter_attr"> 
               
              <a href="javascript:void(0);" data="9">热带水果</a></li>
                      </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:void(0);">查看更多<i></i></a> </div>
        </div>
      </div>
            <div class="attr brandAttr">
        <div class="attrKey">来源</div>
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="10">国产</a></li>
             
                        <li class="filter_attr"> 
               
              <a href="javascript:void(0);" data="16">进口</a></li>
                      </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:void(0);">查看更多<i></i></a> </div>
        </div>
      </div>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=1&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=DESC'})
});
</script>
<script type="text/javascript">
