		...
		<table cellpadding="3" cellspacing="1">
			<tr>
				<th>
					...
					<a href="javascript:listTable.sort('act_id'); "><?php echo $this->_var['lang']['record_id']; ?></a>
					<?php echo $this->_var['sort_act_id']; ?>
				</th>
				<th>
					<a href="javascript:listTable.sort('goods_name'); "><?php echo $this->_var['lang']['goods_name']; ?></a>
					<?php echo $this->_var['sort_goods_name']; ?>
				</th>
				<th>
					<?php echo $this->_var['lang']['current_status']; ?>
					</a>
				</th>
				...
				<th>
					<a href="javascript:listTable.sort('end_time'); "><?php echo $this->_var['lang']['end_date']; ?></a>
					<?php echo $this->_var['sort_end_time']; ?>
				</th>
				<th>
					<a href="javascript:listTable.sort('deposit'); "><?php echo $this->_var['lang']['deposit']; ?></a>
					<?php echo $this->_var['sort_deposit']; ?>
				</th>
				<th>
					<a href="javascript:listTable.sort('restrict_amount'); "><?php echo $this->_var['lang']['restrict_amount']; ?></a>
					<?php echo $this->_var['sort_restrict_amount']; ?>
				</th>
				...
				<th>
					<?php echo $this->_var['lang']['valid_goods']; ?>
					</a>
				</th>
				<th>
					<?php echo $this->_var['lang']['valid_order']; ?>
					</a>
				</th>
				<th>
					<?php echo $this->_var['lang']['current_price']; ?>
					</a>
				</th>
...
?>
			<tr>
				<td>
					<input value="<?php echo $this->_var['pre_sale']['act_id']; ?>" name="checkboxes[]" type="checkbox">
					<?php echo $this->_var['pre_sale']['act_id']; ?>
				</td>
				...
				<td align="right">
					<span onclick="listTable.edit(this, 'edit_deposit', <?php echo $this->_var['pre_sale']['act_id']; ?>)"><?php echo $this->_var['pre_sale']['deposit']; ?></span>
				</td>
				<td align="right">
					<span onclick="listTable.edit(this, 'edit_restrict_amount', <?php echo $this->_var['pre_sale']['act_id']; ?>)"><?php echo $this->_var['pre_sale']['restrict_amount']; ?></span>
				</td>
				...
				<td align="center">
					<a href="order.php?act=list&amp;pre_sale_id=<?php echo $this->_var['pre_sale']['act_id']; ?>&suppid=<?php echo $this->_var['pre_sale']['supplier_id']; ?>">
						<img src="images/icon_view.gif" title="<?php echo $this->_var['lang']['view_order']; ?>" border="0" width="21" height="21" />
					</a>
					<a href="pre_sale.php?act=edit&amp;id=<?php echo $this->_var['pre_sale']['act_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>">
						<img src="images/icon_edit.gif" border="0" width="21" height="21" />
					</a>
					<a href="javascript:remove('<?php echo $this->_var['pre_sale']['act_id']; ?>');" title="<?php echo $this->_var['lang']['remove']; ?>">
						<img src="images/icon_drop.gif" border="0" width="21" height="21" />
					</a>
				</td>
			</tr>
			<?php endforeach; else: ?>
