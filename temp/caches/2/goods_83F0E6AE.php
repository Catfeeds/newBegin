...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '500件';
    }else{
...
<div id="wrapper">
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">精选优品</a> <code>&gt;</code> <a href="category.php?id=47">南北干货</a> <code>&gt;</code> <a href="category.php?id=352">海带/笋干/紫菜</a> <code>&gt;</code> 测试</div>
  <div class="detail cle"> 
     
    <div class="detail_img" id="detail_img">
  <div class="pic_view" id="li_111"> <a href="images/201707/goods_img/111_P_1499031717173.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 10;zoom-width: 400; zoom-height: 400;"> <img id="J_prodImg"  alt="测试" data-original="images/201707/goods_img/111_P_1499031717173.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_111"> </a> </div>
  ...
  <a class="next" href="javascript:void(0);"></a>
    ...
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201707/goods_img/111_P_1499031717173.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/111_P_1499031717173.jpg"> <img data-original="images/201707/thumb_img/111_thumb_P_1499031717080.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="测试"> </a></li>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>  
    ...
    <form action="javascript:addToCart(111)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <div class="item-info" id="item-info">
	    ...
	    <div class="itemPanel">
                		   <h2>本店价：<i id="ECS_SHOPPRICE"><font>￥0.01</font></i></h2>
	           	              <div class="market_price">市场价：<em><font>￥0.01</font></em></div>
	      ...
	      <span class="itemMoreInfo"><a href="javascript:;" rel="nofollow">已售出 <span class="sales">35</span></a>|<a href="javascript:;" rel="nofollow">0 人评价</a></span>
	    </div>
            <ul>
                            ...
                            <li><span class="lbl">品&nbsp;&nbsp;&nbsp;牌</span><a href="brand.php?id=1" target="_blank">进入&nbsp;<font style="color:#1ac14b;">元祖良品</font>&nbsp;品牌馆</a></li>
               
              
               
              
                            <li><span>可使用<em class="red">1100</em>金币</span></li>
...
var myString=new Array();
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart_quick(111)" class="btn-buy" id="buy_btn"><font id="nowbuy">立即购买</font></a> <a href="javascript:addToCart(111)" class="btn" id="buy_btn"><font id="nowbuy">加入购物车</font></a> <a id="fav-btn" class="graybtn" href="javascript:collect(111)"><i class="iconfont">&#xe606;</i>收藏</a> 
	      <a href="javascript:;" class="btn_wap" id="phone">去手机购买
		<div style="display: none;" id="phone_tan"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img width="100" height="100" src="erweima_png.php?id=111"> </div>
                </div>
	      </a>
              <script type="text/javascript">
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 111); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 111); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),111); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),111); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
*/
	...
	<a href="http://www.0769web.net"><img src="images/upload/Image/201606.jpg" alt="" /></a>
	      ...
	      <h4>用户评价</h4>
              <div class="z-detail-com-box" id="ECS_COMMENT">554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:111;}554fcae493e564ee0dc75bdf2ebf94ca</div>
          </div>
        </div>
      </div>
	  ...
	  <div class="z-detail-right">
	  	...
	  	<div class="hot_box">
			<ul>
												<li>
					<a href="goods.php?id=102" target="_self">
						<img width="194px" height="194px" data-original="images/201707/thumb_img/102_thumb_G_1499030381370.jpg" src="themes/shengxian/images/spacer.gif" class="loading" />
						<p>新鲜猪扒肉</p>
						<p class="hot_price">
							          					<font>￥30.00</font>          											</p>
					</a>
																...
																<li>
					<a href="goods.php?id=4" target="_self">
						<img width="194px" height="194px" data-original="images/201707/thumb_img/4_thumb_G_1498959094209.jpg" src="themes/shengxian/images/spacer.gif" class="loading" />
						<p>通菜（通心菜、空心菜、竹叶菜）</p>
						<p class="hot_price">
							          					<font>￥5.48</font>          											</p>
					</a>
					...
					<a href="goods.php?id=73" target="_self">
						<img width="194px" height="194px" data-original="images/201707/thumb_img/73_thumb_G_1498970320832.jpg" src="themes/shengxian/images/spacer.gif" class="loading" />
						<p>Aji酵母减盐味苏打饼干472.5g/袋早餐牛奶休闲零食</p>
						<p class="hot_price">
							          					<font>￥9.90</font>          											</p>
					</a>
				</li>
																<li>
					<a href="goods.php?id=78" target="_self">
						<img width="194px" height="194px" data-original="images/201707/thumb_img/78_thumb_G_1498970798201.jpg" src="themes/shengxian/images/spacer.gif" class="loading" />
						<p>姚太太 九制半梅160g 蜜饯果干话梅子 休闲零食小吃</p>
						<p class="hot_price">
							          					<font>￥10.88</font>          											</p>
					</a>
				</li>
					...
					<a href="goods.php?id=81" target="_self">
						<img width="194px" height="194px" data-original="images/201707/thumb_img/81_thumb_G_1498971165827.jpg" src="themes/shengxian/images/spacer.gif" class="loading" />
						<p>佳宝加应子500g话梅 李子干梅子</p>
						<p class="hot_price">
							          					<font>￥19.99</font>          											</p>
					</a>
				</li>
...
<div class="itemBar" style="">
	<div class="wrapper">
		<div class="itemBuy"><a href="javascript:addToCart(111)" class="itemAddCart">加入购物车</a></div>
		<div class="itemMin" title="测试">
			<span><img src="images/201707/thumb_img/111_thumb_G_1499031717433.jpg"></span>
			<p>测试</p>
		</div>
