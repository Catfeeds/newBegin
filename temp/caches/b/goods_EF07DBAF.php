...
<title>鲁花5S一级花生油_花生油_食用油_粮油副食_绿色生鲜商城+手机+微信商城+APP最新版</title>
...
<div id="wrapper">
  ...
  <a class="next" href="javascript:void(0);"></a>
    ...
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201707/goods_img/71_P_1498970104365.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/71_P_1498970104365.jpg"> <img data-original="images/201707/thumb_img/71_thumb_P_1498970104610.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="鲁花5S一级花生油"> </a></li>
      ...
      <div class="item-info" id="item-info">
        <dl class="loaded">
          ...
          <dt class="product_name">
            <h1>鲁花5S一级花生油</h1>
            <p class="desc"> <span class="gray">品质保证</span> </p>
          </dt>
		...
		<h2>促销价：<i id="ECS_SHOPPRICE"><font>￥198.80</font></i></h2>
                <div class="market_price"><span class="timedown" id="timedown"><i class="iconfont">&#xe607;</i>剩余时间：<strong id="leftTime" class="font_w">请稍等, 正在载入中...</strong></span></div>
                    ...
                    <table width="100%">
                      <tbody>
                        <tr>
                          ...
                          <td>QQ用户</td>
                          <td><font>￥169.90</font></td>
                        </tr>
                                                <tr id="ECS_RANKPRICE_6">
                          <td>一星用户</td>
                          <td><font>￥161.41</font></td>
                        </tr>
                                                <tr id="ECS_RANKPRICE_7">
                          <td>二星用户</td>
                          <td><font>￥152.91</font></td>
                        </tr>
                                              </tbody>
                    </table>
                  </div>
	      ...
	      <span class="itemMoreInfo"><a href="javascript:;" rel="nofollow">已售出 <span class="sales">23</span></a>|<a href="javascript:;" rel="nofollow">0 人评价</a></span>
	    </div>
            <ul>
                            ...
                            <li><span>可使用<em class="red">16900</em>金币</span></li>
...
var myString=new Array();
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart_quick(71)" class="btn-buy" id="buy_btn"><font id="nowbuy">立即购买</font></a> <a href="javascript:addToCart(71)" class="btn" id="buy_btn"><font id="nowbuy">加入购物车</font></a> <a id="fav-btn" class="graybtn" href="javascript:collect(71)"><i class="iconfont">&#xe606;</i>收藏</a> 
	      <a href="javascript:;" class="btn_wap" id="phone">去手机购买
		<div style="display: none;" id="phone_tan"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img width="100" height="100" src="erweima_png.php?id=71"> </div>
                </div>
	      </a>
              <script type="text/javascript">
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 71); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 71); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),71); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),71); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
*/
        ...
        <div class="product_tabs">
          <div class="sectionbox z-box">
            <div class="spxq_main">
              <div class="spxq_dec"><p><a href="http://www.0769web.net"><img src="images/upload/Image/201606.jpg" alt="" /></a></p></div>
            </div>
          </div>
...
<div class="itemBar" style="">
	<div class="wrapper">
		<div class="itemBuy"><a href="javascript:addToCart(71)" class="itemAddCart">加入购物车</a></div>
		<div class="itemMin" title="鲁花5S一级花生油">
			<span><img src="images/201707/thumb_img/71_thumb_G_1498970104133.jpg"></span>
			<p>鲁花5S一级花生油</p>
		</div>
